...
package hds.aplications.com.mycp.authenticator;
 ...
 * that prompts the user for their goLogin information.
 */
class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) {
        ...
        intent.putExtra(mContext.getResources().getString(R.string.KEY_ACCOUNT_ADD_AUTHENTICATOR), true);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle loginOptions) throws NetworkErrorException {
        ...
        // return an error
        if (!authTokenType.equals(mContext.getResources().getString(R.string.AUTHTOKEN_TYPE))) {
        ...
        if (password != null) {
            final String authToken = "uygtillzx-hjgaasdsadf=sdfwuhg";//NetworkUtilities.authenticate(account.name, password);
        ...
        final Intent intent = new Intent(mContext, ActivityLogin.class);
        intent.putExtra(mContext.getResources().getString(R.string.PARAM_USERNAME), account.name);
        intent.putExtra(mContext.getResources().getString(R.string.PARAM_AUTHTOKEN_TYPE), authTokenType);
        intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
        final Bundle bundle = new Bundle();
        bundle.putParcelable(AccountManager.KEY_INTENT, intent);
        return bundle;
    ...
    public Bundle getAccountRemovalAllowed(AccountAuthenticatorResponse response, Account account) throws NetworkErrorException {
        ...
        User userAux = (User)userRepository.getByUser(name);
        if(userAux != null){
            userAux.delete();
        }
